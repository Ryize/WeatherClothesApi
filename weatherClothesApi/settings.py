"""
Django settings for weatherClothesApi project.
...
SECRET_KEY = 'django-insecure--f9^((mb)bfx*6izyea=f5u5k)(3@phqubdnh*1u_8__&c+^@t'
...
ROOT_URLCONF = 'weatherClothesApi.urls'
...
WSGI_APPLICATION = 'weatherClothesApi.wsgi.application'
